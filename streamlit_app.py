...
Nifty 50 Stock Analysis Platform - Fixed Mode Selection
...
with st.sidebar:
    ...
    st.write("Advanced Five-Lens Framework")
    st.markdown("---")
    
    # Mode selection - FIXED to work properly
    selected_mode = st.radio(
        ...
        index=0 if st.session_state.analysis_mode == "Single Stock Analysis" else
              1 if st.session_state.analysis_mode == "Sector Comparison" else
              2 if st.session_state.analysis_mode == "Peer Benchmarking" else 3,
        key="mode_radio",
    ...
    st.write("""
    Five-Lens Framework for comprehensive stock analysis:
    - 📊 Valuation (20%)
    - ✨ Quality (25%)
    - 📈 Growth (20%)
    - 💪 Financial Health (20%)
...
nifty50_registry = {
    ...
    "Axis Bank": {"symbol": "AXISBANK.NS", "sector": "Banking", "pe": 19.5},
    "Asian Paints": {"symbol": "ASIANPAINT.NS", "sector": "Paints", "pe": 38.2},
}
...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    if st.button("📊 Compare Sector", type="primary", key="sector_compare"):
        ...
        st.markdown("---")
        st.info("📊 Sector analysis complete! Detailed metrics and rankings displayed above.")
...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    if st.button("🔄 Benchmark", type="primary", key="benchmark_btn"):
        ...
        st.markdown("---")
        st.info("📊 Benchmarking analysis complete! Detailed peer comparison metrics displayed above.")
...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    st.markdown("---")
    st.info("📊 Portfolio risk analysis complete! Diversification metrics and risk assessment displayed above.")
